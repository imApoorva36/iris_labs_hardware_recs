...
REM
REM Generated by Vivado on Thu May 25 18:44:14 +0530 2023
...
echo "xvlog --incr --relax -prj ZeroDetector_TB_vlog.prj"
call xvlog  --incr --relax -prj ZeroDetector_TB_vlog.prj -log xvlog.log
